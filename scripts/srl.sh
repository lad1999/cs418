...
# cd /c/Users/anhdu/AppData/Local/Programs/Python/Python39
# ./python.exe
...
TRAIN_FILE=E:/emnlp20_depsrl/english.train.conll.fused
DEV_FILE=E:/emnlp20_depsrl/english.dev.conll.fused
...
OMP_NUM_THREADS=3 \
python -m srl.parser --baseline $BASELINE \
